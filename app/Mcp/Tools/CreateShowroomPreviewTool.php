...
#[Name('create_showroom_preview')]
#[Description('Create a short-lived signed preview URL for the current private draft. Use this after edits and before publishing. The URL expires after the configured number of minutes and does not expose the MCP token.')]
#[IsReadOnly]
