...
#[Name('restore_showroom_revision_to_draft')]
#[Description('Copy a previous published revision into the private draft. It does not change the public showroom until publish_showroom is called after preview and review.')]
#[IsDestructive(false)]
#[IsIdempotent]
