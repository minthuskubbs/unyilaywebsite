<section class="unyl-heritage">
    ...
    <div class="unyl-heritage__grid">
        <div class="unyl-heritage__col">
            <a href="{{ url('/shop') }}" class="unyl-hcard unyl-hcard--lg unyl-hcard--big-items" style="--bg-desktop:url('https://unyilaysilver.com/wp-content/uploads/2026/08/Product-Card-Big-Items-1.png'); --bg-mobile:url('https://unyilaysilver.com/wp-content/uploads/2026/08/Product-Card-Big-Items-2.png')">
        ...
        <div class="unyl-heritage__col">
            ...
            <a href="{{ url('/product-category/silver-jewelry') }}" class="unyl-hcard unyl-hcard--lg unyl-hcard--jewelry" style="--bg-desktop:url('https://unyilaysilver.com/wp-content/uploads/2026/08/Product-Card-Silver-Jewelry-1.png'); --bg-mobile:url('https://unyilaysilver.com/wp-content/uploads/2026/08/Product-Card-Big-Items-4.png')">
                <div class="unyl-hcard__cap">
