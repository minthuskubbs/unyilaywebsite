<x-layouts.app :categories="$categories" title="My Account — U Nyi Lay Silver Shop">
    <div class="unyl-page unyl-account">
        ...
        <nav class="unyl-account__nav">
            <a href="{{ route('account.dashboard') }}" class="is-active">Dashboard</a>
        ...
        <section class="unyl-account__section">
            ...
            @else
                ...
                <a href="{{ route('account.orders') }}" class="unyl-account__view-all">View all orders &rarr;</a>
            @endif
        </section>
    </div>
</x-layouts.app>
